...
(*DONT_TOUCH="TRUE"*)module buffer(	// core/src/core.scala:94:7
  input         clock,	// core/src/core.scala:94:7
                reset,	// core/src/core.scala:94:7
  output        io_prev_ready,	// core/src/core.scala:95:16
  input         io_prev_valid,	// core/src/core.scala:95:16
  input  [31:0] io_prev_bits_pc,	// core/src/core.scala:95:16
                io_prev_bits_inst,	// core/src/core.scala:95:16
  output        io_next_valid,	// core/src/core.scala:95:16
  output [31:0] io_next_bits_pc,	// core/src/core.scala:95:16
                io_next_bits_inst,	// core/src/core.scala:95:16
  input         io_stall,	// core/src/core.scala:95:16
                io_flush	// core/src/core.scala:95:16
);

  reg        state;	// core/src/core.scala:101:24
  reg [31:0] regs_pc;	// core/src/core.scala:102:19
  reg [31:0] regs_inst;	// core/src/core.scala:102:19
  always @(posedge clock) begin	// core/src/core.scala:94:7
    if (reset)	// core/src/core.scala:94:7
      state <= 1'h0;	// core/src/core.scala:101:24
    else	// core/src/core.scala:94:7
      state <= ~io_flush & (io_stall ? state : io_prev_valid);	// core/src/core.scala:101:24, :105:28, :106:15, :109:33, :110:15, :113:30
    if (io_flush) begin	// core/src/core.scala:94:7
      regs_pc <= 32'h0;	// core/src/core.scala:102:19, :107:29
      regs_inst <= 32'h0;	// core/src/core.scala:102:19, :107:29
    end
    else if (io_stall) begin	// core/src/core.scala:95:16
    end
    else begin	// core/src/core.scala:95:16
      regs_pc <= io_prev_valid ? io_prev_bits_pc : 32'h0;	// core/src/core.scala:102:19, :107:29, :113:30, :115:14, :119:14
      regs_inst <= io_prev_valid ? io_prev_bits_inst : 32'h0;	// core/src/core.scala:102:19, :107:29, :113:30, :115:14, :119:14
    end
  end // always @(posedge)
  `ifdef ENABLE_INITIAL_REG_	// core/src/core.scala:94:7
    `ifdef FIRRTL_BEFORE_INITIAL	// core/src/core.scala:94:7
      `FIRRTL_BEFORE_INITIAL	// core/src/core.scala:94:7
    `endif // FIRRTL_BEFORE_INITIAL
    initial begin	// core/src/core.scala:94:7
      automatic logic [31:0] _RANDOM[0:2];	// core/src/core.scala:94:7
      `ifdef INIT_RANDOM_PROLOG_	// core/src/core.scala:94:7
        `INIT_RANDOM_PROLOG_	// core/src/core.scala:94:7
      `endif // INIT_RANDOM_PROLOG_
      `ifdef RANDOMIZE_REG_INIT	// core/src/core.scala:94:7
        for (logic [1:0] i = 2'h0; i < 2'h3; i += 2'h1) begin
          _RANDOM[i] = `RANDOM;	// core/src/core.scala:94:7
        end	// core/src/core.scala:94:7
        state = _RANDOM[2'h0][0];	// core/src/core.scala:94:7, :101:24
        regs_pc = {_RANDOM[2'h0][31:1], _RANDOM[2'h1][0]};	// core/src/core.scala:94:7, :101:24, :102:19
        regs_inst = {_RANDOM[2'h1][31:1], _RANDOM[2'h2][0]};	// core/src/core.scala:94:7, :102:19
      `endif // RANDOMIZE_REG_INIT
    end // initial
    `ifdef FIRRTL_AFTER_INITIAL	// core/src/core.scala:94:7
      `FIRRTL_AFTER_INITIAL	// core/src/core.scala:94:7
    `endif // FIRRTL_AFTER_INITIAL
  `endif // ENABLE_INITIAL_REG_
  assign io_prev_ready = ~io_stall & ~io_flush;	// core/src/core.scala:94:7, :103:{26,34,46}
  assign io_next_valid = state;	// core/src/core.scala:94:7, :101:24
  assign io_next_bits_pc = regs_pc;	// core/src/core.scala:94:7, :102:19
  assign io_next_bits_inst = regs_inst;	// core/src/core.scala:94:7, :102:19
endmodule
...
(*DONT_TOUCH="TRUE"*)module buffer_1(	// core/src/core.scala:94:7
  input         clock,	// core/src/core.scala:94:7
                reset,	// core/src/core.scala:94:7
                io_prev_valid,	// core/src/core.scala:95:16
  input  [3:0]  io_prev_bits_aluOp,	// core/src/core.scala:95:16
  input  [1:0]  io_prev_bits_aluAsrc,	// core/src/core.scala:95:16
  input  [2:0]  io_prev_bits_aluBsrc,	// core/src/core.scala:95:16
  input  [3:0]  io_prev_bits_branchOp,	// core/src/core.scala:95:16
                io_prev_bits_memOp,	// core/src/core.scala:95:16
  input  [1:0]  io_prev_bits_wbSel,	// core/src/core.scala:95:16
                io_prev_bits_wbDst,	// core/src/core.scala:95:16
  input  [31:0] io_prev_bits_Imm,	// core/src/core.scala:95:16
  input  [4:0]  io_prev_bits_rd,	// core/src/core.scala:95:16
  input  [31:0] io_prev_bits_rd_data,	// core/src/core.scala:95:16
                io_prev_bits_rj_data,	// core/src/core.scala:95:16
                io_prev_bits_rk_data,	// core/src/core.scala:95:16
  input  [2:0]  io_prev_bits_FwEX_RD,	// core/src/core.scala:95:16
                io_prev_bits_FwEX_RJ,	// core/src/core.scala:95:16
                io_prev_bits_FwEX_RK,	// core/src/core.scala:95:16
  input  [31:0] io_prev_bits_pc,	// core/src/core.scala:95:16
  output        io_next_valid,	// core/src/core.scala:95:16
  output [3:0]  io_next_bits_aluOp,	// core/src/core.scala:95:16
  output [1:0]  io_next_bits_aluAsrc,	// core/src/core.scala:95:16
  output [2:0]  io_next_bits_aluBsrc,	// core/src/core.scala:95:16
  output [3:0]  io_next_bits_branchOp,	// core/src/core.scala:95:16
                io_next_bits_memOp,	// core/src/core.scala:95:16
  output [1:0]  io_next_bits_wbSel,	// core/src/core.scala:95:16
                io_next_bits_wbDst,	// core/src/core.scala:95:16
  output [31:0] io_next_bits_Imm,	// core/src/core.scala:95:16
  output [4:0]  io_next_bits_rd,	// core/src/core.scala:95:16
  output [31:0] io_next_bits_rd_data,	// core/src/core.scala:95:16
                io_next_bits_rj_data,	// core/src/core.scala:95:16
                io_next_bits_rk_data,	// core/src/core.scala:95:16
  output [2:0]  io_next_bits_FwEX_RD,	// core/src/core.scala:95:16
                io_next_bits_FwEX_RJ,	// core/src/core.scala:95:16
                io_next_bits_FwEX_RK,	// core/src/core.scala:95:16
  output [31:0] io_next_bits_pc,	// core/src/core.scala:95:16
  input         io_flush	// core/src/core.scala:95:16
);

  reg        state;	// core/src/core.scala:101:24
  reg [3:0]  regs_aluOp;	// core/src/core.scala:102:19
  reg [1:0]  regs_aluAsrc;	// core/src/core.scala:102:19
  reg [2:0]  regs_aluBsrc;	// core/src/core.scala:102:19
  reg [3:0]  regs_branchOp;	// core/src/core.scala:102:19
  reg [3:0]  regs_memOp;	// core/src/core.scala:102:19
  reg [1:0]  regs_wbSel;	// core/src/core.scala:102:19
  reg [1:0]  regs_wbDst;	// core/src/core.scala:102:19
  reg [31:0] regs_Imm;	// core/src/core.scala:102:19
  reg [4:0]  regs_rd;	// core/src/core.scala:102:19
  reg [31:0] regs_rd_data;	// core/src/core.scala:102:19
  reg [31:0] regs_rj_data;	// core/src/core.scala:102:19
  reg [31:0] regs_rk_data;	// core/src/core.scala:102:19
  reg [2:0]  regs_FwEX_RD;	// core/src/core.scala:102:19
  reg [2:0]  regs_FwEX_RJ;	// core/src/core.scala:102:19
  reg [2:0]  regs_FwEX_RK;	// core/src/core.scala:102:19
  reg [31:0] regs_pc;	// core/src/core.scala:102:19
  always @(posedge clock) begin	// core/src/core.scala:94:7
    if (reset)	// core/src/core.scala:94:7
      state <= 1'h0;	// core/src/core.scala:95:16, :101:24
    else	// core/src/core.scala:94:7
      state <= ~io_flush & io_prev_valid;	// core/src/core.scala:101:24, :105:28, :106:15, :109:33
    if (io_flush) begin	// core/src/core.scala:94:7
      regs_aluOp <= 4'h0;	// core/src/core.scala:102:19, :107:29
      regs_aluAsrc <= 2'h0;	// core/src/core.scala:102:19, :107:29
      regs_aluBsrc <= 3'h0;	// core/src/core.scala:94:7, :102:19
      regs_branchOp <= 4'h0;	// core/src/core.scala:102:19, :107:29
      regs_memOp <= 4'h0;	// core/src/core.scala:102:19, :107:29
      regs_wbSel <= 2'h0;	// core/src/core.scala:102:19, :107:29
      regs_wbDst <= 2'h0;	// core/src/core.scala:102:19, :107:29
      regs_Imm <= 32'h0;	// core/src/core.scala:102:19, :107:29
      regs_rd <= 5'h0;	// core/src/core.scala:102:19, :107:29
      regs_rd_data <= 32'h0;	// core/src/core.scala:102:19, :107:29
      regs_rj_data <= 32'h0;	// core/src/core.scala:102:19, :107:29
      regs_rk_data <= 32'h0;	// core/src/core.scala:102:19, :107:29
      regs_FwEX_RD <= 3'h0;	// core/src/core.scala:94:7, :102:19
      regs_FwEX_RJ <= 3'h0;	// core/src/core.scala:94:7, :102:19
      regs_FwEX_RK <= 3'h0;	// core/src/core.scala:94:7, :102:19
      regs_pc <= 32'h0;	// core/src/core.scala:102:19, :107:29
    end
    else begin	// core/src/core.scala:94:7
      regs_aluOp <= io_prev_valid ? io_prev_bits_aluOp : 4'h0;	// core/src/core.scala:102:19, :107:29, :113:30, :115:14, :119:14
      regs_aluAsrc <= io_prev_valid ? io_prev_bits_aluAsrc : 2'h0;	// core/src/core.scala:102:19, :107:29, :113:30, :115:14, :119:14
      regs_aluBsrc <= io_prev_valid ? io_prev_bits_aluBsrc : 3'h0;	// core/src/core.scala:94:7, :102:19, :113:30, :115:14, :119:14
      regs_branchOp <= io_prev_valid ? io_prev_bits_branchOp : 4'h0;	// core/src/core.scala:102:19, :107:29, :113:30, :115:14, :119:14
      regs_memOp <= io_prev_valid ? io_prev_bits_memOp : 4'h0;	// core/src/core.scala:102:19, :107:29, :113:30, :115:14, :119:14
      regs_wbSel <= io_prev_valid ? io_prev_bits_wbSel : 2'h0;	// core/src/core.scala:102:19, :107:29, :113:30, :115:14, :119:14
      regs_wbDst <= io_prev_valid ? io_prev_bits_wbDst : 2'h0;	// core/src/core.scala:102:19, :107:29, :113:30, :115:14, :119:14
      regs_Imm <= io_prev_valid ? io_prev_bits_Imm : 32'h0;	// core/src/core.scala:102:19, :107:29, :113:30, :115:14, :119:14
      regs_rd <= io_prev_valid ? io_prev_bits_rd : 5'h0;	// core/src/core.scala:102:19, :107:29, :113:30, :115:14, :119:14
      regs_rd_data <= io_prev_valid ? io_prev_bits_rd_data : 32'h0;	// core/src/core.scala:102:19, :107:29, :113:30, :115:14, :119:14
      regs_rj_data <= io_prev_valid ? io_prev_bits_rj_data : 32'h0;	// core/src/core.scala:102:19, :107:29, :113:30, :115:14, :119:14
      regs_rk_data <= io_prev_valid ? io_prev_bits_rk_data : 32'h0;	// core/src/core.scala:102:19, :107:29, :113:30, :115:14, :119:14
      regs_FwEX_RD <= io_prev_valid ? io_prev_bits_FwEX_RD : 3'h0;	// core/src/core.scala:94:7, :102:19, :113:30, :115:14, :119:14
      regs_FwEX_RJ <= io_prev_valid ? io_prev_bits_FwEX_RJ : 3'h0;	// core/src/core.scala:94:7, :102:19, :113:30, :115:14, :119:14
      regs_FwEX_RK <= io_prev_valid ? io_prev_bits_FwEX_RK : 3'h0;	// core/src/core.scala:94:7, :102:19, :113:30, :115:14, :119:14
      regs_pc <= io_prev_valid ? io_prev_bits_pc : 32'h0;	// core/src/core.scala:102:19, :107:29, :113:30, :115:14, :119:14
    end
  end // always @(posedge)
  `ifdef ENABLE_INITIAL_REG_	// core/src/core.scala:94:7
    ...
    `endif // FIRRTL_BEFORE_INITIAL
    initial begin	// core/src/core.scala:94:7
      automatic logic [31:0] _RANDOM[0:6];	// core/src/core.scala:94:7
      `ifdef INIT_RANDOM_PROLOG_	// core/src/core.scala:94:7
        `INIT_RANDOM_PROLOG_	// core/src/core.scala:94:7
      `endif // INIT_RANDOM_PROLOG_
      `ifdef RANDOMIZE_REG_INIT	// core/src/core.scala:94:7
        ...
        state = _RANDOM[3'h0][0];	// core/src/core.scala:94:7, :101:24
        regs_aluOp = _RANDOM[3'h0][4:1];	// core/src/core.scala:94:7, :101:24, :102:19
        regs_aluAsrc = _RANDOM[3'h0][6:5];	// core/src/core.scala:94:7, :101:24, :102:19
        regs_aluBsrc = _RANDOM[3'h0][9:7];	// core/src/core.scala:94:7, :101:24, :102:19
        regs_branchOp = _RANDOM[3'h0][13:10];	// core/src/core.scala:94:7, :101:24, :102:19
        regs_memOp = _RANDOM[3'h0][17:14];	// core/src/core.scala:94:7, :101:24, :102:19
        regs_wbSel = _RANDOM[3'h0][19:18];	// core/src/core.scala:94:7, :101:24, :102:19
        regs_wbDst = _RANDOM[3'h0][21:20];	// core/src/core.scala:94:7, :101:24, :102:19
        regs_Imm = {_RANDOM[3'h0][31:22], _RANDOM[3'h1][21:0]};	// core/src/core.scala:94:7, :101:24, :102:19
        regs_rd = _RANDOM[3'h1][26:22];	// core/src/core.scala:94:7, :102:19
        regs_rd_data = {_RANDOM[3'h2][31:5], _RANDOM[3'h3][4:0]};	// core/src/core.scala:94:7, :102:19
        regs_rj_data = {_RANDOM[3'h3][31:5], _RANDOM[3'h4][4:0]};	// core/src/core.scala:94:7, :102:19
        regs_rk_data = {_RANDOM[3'h4][31:5], _RANDOM[3'h5][4:0]};	// core/src/core.scala:94:7, :102:19
        regs_FwEX_RD = _RANDOM[3'h5][7:5];	// core/src/core.scala:94:7, :102:19
        regs_FwEX_RJ = _RANDOM[3'h5][10:8];	// core/src/core.scala:94:7, :102:19
        regs_FwEX_RK = _RANDOM[3'h5][13:11];	// core/src/core.scala:94:7, :102:19
        regs_pc = {_RANDOM[3'h5][31:14], _RANDOM[3'h6][13:0]};	// core/src/core.scala:94:7, :102:19
      `endif // RANDOMIZE_REG_INIT
    end // initial
    `ifdef FIRRTL_AFTER_INITIAL	// core/src/core.scala:94:7
      `FIRRTL_AFTER_INITIAL	// core/src/core.scala:94:7
  ...
  `endif // ENABLE_INITIAL_REG_
  assign io_next_valid = state;	// core/src/core.scala:94:7, :101:24
  assign io_next_bits_aluOp = regs_aluOp;	// core/src/core.scala:94:7, :102:19
  assign io_next_bits_aluAsrc = regs_aluAsrc;	// core/src/core.scala:94:7, :102:19
  assign io_next_bits_aluBsrc = regs_aluBsrc;	// core/src/core.scala:94:7, :102:19
  assign io_next_bits_branchOp = regs_branchOp;	// core/src/core.scala:94:7, :102:19
  assign io_next_bits_memOp = regs_memOp;	// core/src/core.scala:94:7, :102:19
  assign io_next_bits_wbSel = regs_wbSel;	// core/src/core.scala:94:7, :102:19
  assign io_next_bits_wbDst = regs_wbDst;	// core/src/core.scala:94:7, :102:19
  assign io_next_bits_Imm = regs_Imm;	// core/src/core.scala:94:7, :102:19
  assign io_next_bits_rd = regs_rd;	// core/src/core.scala:94:7, :102:19
  assign io_next_bits_rd_data = regs_rd_data;	// core/src/core.scala:94:7, :102:19
  assign io_next_bits_rj_data = regs_rj_data;	// core/src/core.scala:94:7, :102:19
  assign io_next_bits_rk_data = regs_rk_data;	// core/src/core.scala:94:7, :102:19
  assign io_next_bits_FwEX_RD = regs_FwEX_RD;	// core/src/core.scala:94:7, :102:19
  assign io_next_bits_FwEX_RJ = regs_FwEX_RJ;	// core/src/core.scala:94:7, :102:19
  assign io_next_bits_FwEX_RK = regs_FwEX_RK;	// core/src/core.scala:94:7, :102:19
  assign io_next_bits_pc = regs_pc;	// core/src/core.scala:94:7, :102:19
endmodule

// external module mult_gen_0

(*DONT_TOUCH="TRUE"*)module bshifter(	// core/src/exu.scala:156:7
  input  [31:0] io_A,	// core/src/exu.scala:157:16
  input  [4:0]  io_B,	// core/src/exu.scala:157:16
  input  [3:0]  io_Op,	// core/src/exu.scala:157:16
  output [31:0] io_Out	// core/src/exu.scala:157:16
);

  wire _GEN = io_Op != 4'h8;	// core/src/exu.scala:170:53
  wire Shifter_1_0 =
    io_B[0] ? (io_Op == 4'hA | io_Op == 4'h9 ? io_A[1] : _GEN & io_A[0]) : io_A[0];	// core/src/exu.scala:165:24, :169:{37,43}, :170:53
  wire Shifter_1_1 =
    io_B[0]
      ? (io_Op == 4'hA | io_Op == 4'h9 ? io_A[2] : io_Op == 4'h8 ? io_A[0] : io_A[1])
      : io_A[1];	// core/src/exu.scala:165:24, :169:43, :170:53, :185:37, :186:53
  wire Shifter_1_2 =
    io_B[0]
      ? (io_Op == 4'hA | io_Op == 4'h9 ? io_A[3] : io_Op == 4'h8 ? io_A[1] : io_A[2])
      : io_A[2];	// core/src/exu.scala:165:24, :169:43, :170:53, :185:37, :186:53
  wire Shifter_1_3 =
    io_B[0]
      ? (io_Op == 4'hA | io_Op == 4'h9 ? io_A[4] : io_Op == 4'h8 ? io_A[2] : io_A[3])
      : io_A[3];	// core/src/exu.scala:165:24, :169:43, :170:53, :185:37, :186:53
  wire Shifter_1_4 =
    io_B[0]
      ? (io_Op == 4'hA | io_Op == 4'h9 ? io_A[5] : io_Op == 4'h8 ? io_A[3] : io_A[4])
      : io_A[4];	// core/src/exu.scala:165:24, :169:43, :170:53, :185:37, :186:53
  wire Shifter_1_5 =
    io_B[0]
      ? (io_Op == 4'hA | io_Op == 4'h9 ? io_A[6] : io_Op == 4'h8 ? io_A[4] : io_A[5])
      : io_A[5];	// core/src/exu.scala:165:24, :169:43, :170:53, :185:37, :186:53
  wire Shifter_1_6 =
    io_B[0]
      ? (io_Op == 4'hA | io_Op == 4'h9 ? io_A[7] : io_Op == 4'h8 ? io_A[5] : io_A[6])
      : io_A[6];	// core/src/exu.scala:165:24, :169:43, :170:53, :185:37, :186:53
  wire Shifter_1_7 =
    io_B[0]
      ? (io_Op == 4'hA | io_Op == 4'h9 ? io_A[8] : io_Op == 4'h8 ? io_A[6] : io_A[7])
      : io_A[7];	// core/src/exu.scala:165:24, :169:43, :170:53, :185:37, :186:53
  wire Shifter_1_8 =
    io_B[0]
      ? (io_Op == 4'hA | io_Op == 4'h9 ? io_A[9] : io_Op == 4'h8 ? io_A[7] : io_A[8])
      : io_A[8];	// core/src/exu.scala:165:24, :169:43, :170:53, :185:37, :186:53
  wire Shifter_1_9 =
    io_B[0]
      ? (io_Op == 4'hA | io_Op == 4'h9 ? io_A[10] : io_Op == 4'h8 ? io_A[8] : io_A[9])
      : io_A[9];	// core/src/exu.scala:165:24, :169:43, :170:53, :185:37, :186:53
  wire Shifter_1_10 =
    io_B[0]
      ? (io_Op == 4'hA | io_Op == 4'h9 ? io_A[11] : io_Op == 4'h8 ? io_A[9] : io_A[10])
      : io_A[10];	// core/src/exu.scala:165:24, :169:43, :170:53, :185:37, :186:53
  wire Shifter_1_11 =
    io_B[0]
      ? (io_Op == 4'hA | io_Op == 4'h9 ? io_A[12] : io_Op == 4'h8 ? io_A[10] : io_A[11])
      : io_A[11];	// core/src/exu.scala:165:24, :169:43, :170:53, :185:37, :186:53
  wire Shifter_1_12 =
    io_B[0]
      ? (io_Op == 4'hA | io_Op == 4'h9 ? io_A[13] : io_Op == 4'h8 ? io_A[11] : io_A[12])
      : io_A[12];	// core/src/exu.scala:165:24, :169:43, :170:53, :185:37, :186:53
  wire Shifter_1_13 =
    io_B[0]
      ? (io_Op == 4'hA | io_Op == 4'h9 ? io_A[14] : io_Op == 4'h8 ? io_A[12] : io_A[13])
      : io_A[13];	// core/src/exu.scala:165:24, :169:43, :170:53, :185:37, :186:53
  wire Shifter_1_14 =
    io_B[0]
      ? (io_Op == 4'hA | io_Op == 4'h9 ? io_A[15] : io_Op == 4'h8 ? io_A[13] : io_A[14])
      : io_A[14];	// core/src/exu.scala:165:24, :169:43, :170:53, :185:37, :186:53
  wire Shifter_1_15 =
    io_B[0]
      ? (io_Op == 4'hA | io_Op == 4'h9 ? io_A[16] : io_Op == 4'h8 ? io_A[14] : io_A[15])
      : io_A[15];	// core/src/exu.scala:165:24, :169:43, :170:53, :185:37, :186:53
  wire Shifter_1_16 =
    io_B[0]
      ? (io_Op == 4'hA | io_Op == 4'h9 ? io_A[17] : io_Op == 4'h8 ? io_A[15] : io_A[16])
      : io_A[16];	// core/src/exu.scala:165:24, :169:43, :170:53, :185:37, :186:53
  wire Shifter_1_17 =
    io_B[0]
      ? (io_Op == 4'hA | io_Op == 4'h9 ? io_A[18] : io_Op == 4'h8 ? io_A[16] : io_A[17])
      : io_A[17];	// core/src/exu.scala:165:24, :169:43, :170:53, :185:37, :186:53
  wire Shifter_1_18 =
    io_B[0]
      ? (io_Op == 4'hA | io_Op == 4'h9 ? io_A[19] : io_Op == 4'h8 ? io_A[17] : io_A[18])
      : io_A[18];	// core/src/exu.scala:165:24, :169:43, :170:53, :185:37, :186:53
  wire Shifter_1_19 =
    io_B[0]
      ? (io_Op == 4'hA | io_Op == 4'h9 ? io_A[20] : io_Op == 4'h8 ? io_A[18] : io_A[19])
      : io_A[19];	// core/src/exu.scala:165:24, :169:43, :170:53, :185:37, :186:53
  wire Shifter_1_20 =
    io_B[0]
      ? (io_Op == 4'hA | io_Op == 4'h9 ? io_A[21] : io_Op == 4'h8 ? io_A[19] : io_A[20])
      : io_A[20];	// core/src/exu.scala:165:24, :169:43, :170:53, :185:37, :186:53
  wire Shifter_1_21 =
    io_B[0]
      ? (io_Op == 4'hA | io_Op == 4'h9 ? io_A[22] : io_Op == 4'h8 ? io_A[20] : io_A[21])
      : io_A[21];	// core/src/exu.scala:165:24, :169:43, :170:53, :185:37, :186:53
  wire Shifter_1_22 =
    io_B[0]
      ? (io_Op == 4'hA | io_Op == 4'h9 ? io_A[23] : io_Op == 4'h8 ? io_A[21] : io_A[22])
      : io_A[22];	// core/src/exu.scala:165:24, :169:43, :170:53, :185:37, :186:53
  wire Shifter_1_23 =
    io_B[0]
      ? (io_Op == 4'hA | io_Op == 4'h9 ? io_A[24] : io_Op == 4'h8 ? io_A[22] : io_A[23])
      : io_A[23];	// core/src/exu.scala:165:24, :169:43, :170:53, :185:37, :186:53
  wire Shifter_1_24 =
    io_B[0]
      ? (io_Op == 4'hA | io_Op == 4'h9 ? io_A[25] : io_Op == 4'h8 ? io_A[23] : io_A[24])
      : io_A[24];	// core/src/exu.scala:165:24, :169:43, :170:53, :185:37, :186:53
  wire Shifter_1_25 =
    io_B[0]
      ? (io_Op == 4'hA | io_Op == 4'h9 ? io_A[26] : io_Op == 4'h8 ? io_A[24] : io_A[25])
      : io_A[25];	// core/src/exu.scala:165:24, :169:43, :170:53, :185:37, :186:53
  wire Shifter_1_26 =
    io_B[0]
      ? (io_Op == 4'hA | io_Op == 4'h9 ? io_A[27] : io_Op == 4'h8 ? io_A[25] : io_A[26])
      : io_A[26];	// core/src/exu.scala:165:24, :169:43, :170:53, :185:37, :186:53
  wire Shifter_1_27 =
    io_B[0]
      ? (io_Op == 4'hA | io_Op == 4'h9 ? io_A[28] : io_Op == 4'h8 ? io_A[26] : io_A[27])
      : io_A[27];	// core/src/exu.scala:165:24, :169:43, :170:53, :185:37, :186:53
  wire Shifter_1_28 =
    io_B[0]
      ? (io_Op == 4'hA | io_Op == 4'h9 ? io_A[29] : io_Op == 4'h8 ? io_A[27] : io_A[28])
      : io_A[28];	// core/src/exu.scala:165:24, :169:43, :170:53, :185:37, :186:53
  wire Shifter_1_29 =
    io_B[0]
      ? (io_Op == 4'hA | io_Op == 4'h9 ? io_A[30] : io_Op == 4'h8 ? io_A[28] : io_A[29])
      : io_A[29];	// core/src/exu.scala:165:24, :169:43, :170:53, :185:37, :186:53
  wire Shifter_1_30 =
    io_B[0]
      ? (io_Op == 4'hA | io_Op == 4'h9 ? io_A[31] : io_Op == 4'h8 ? io_A[29] : io_A[30])
      : io_A[30];	// core/src/exu.scala:165:24, :169:43, :170:53, :185:37, :186:53
  wire _GEN_0 = io_Op != 4'h9;	// core/src/exu.scala:170:53, :178:53
  wire Shifter_1_31 =
    ~(io_B[0]) | io_Op == 4'hA
      ? io_A[31]
      : _GEN_0 & (io_Op == 4'h8 ? io_A[30] : io_A[31]);	// core/src/exu.scala:165:24, :169:43, :170:53, :177:37, :178:53
  wire Shifter_2_0 =
    io_B[1]
      ? (io_Op == 4'hA | io_Op == 4'h9 ? Shifter_1_2 : _GEN & Shifter_1_0)
      : Shifter_1_0;	// core/src/exu.scala:169:{37,43}, :170:53, :185:37
  wire Shifter_2_1 =
    io_B[1]
      ? (io_Op == 4'hA | io_Op == 4'h9 ? Shifter_1_3 : _GEN & Shifter_1_1)
      : Shifter_1_1;	// core/src/exu.scala:169:{37,43}, :170:53, :185:37
  wire Shifter_2_2 =
    io_B[1]
      ? (io_Op == 4'hA | io_Op == 4'h9
           ? Shifter_1_4
           : io_Op == 4'h8 ? Shifter_1_0 : Shifter_1_2)
      : Shifter_1_2;	// core/src/exu.scala:169:{37,43}, :170:53, :185:37, :186:53
  wire Shifter_2_3 =
    io_B[1]
      ? (io_Op == 4'hA | io_Op == 4'h9
           ? Shifter_1_5
           : io_Op == 4'h8 ? Shifter_1_1 : Shifter_1_3)
      : Shifter_1_3;	// core/src/exu.scala:169:43, :170:53, :185:37, :186:53
  wire Shifter_2_4 =
    io_B[1]
      ? (io_Op == 4'hA | io_Op == 4'h9
           ? Shifter_1_6
           : io_Op == 4'h8 ? Shifter_1_2 : Shifter_1_4)
      : Shifter_1_4;	// core/src/exu.scala:169:43, :170:53, :185:37, :186:53
  wire Shifter_2_5 =
    io_B[1]
      ? (io_Op == 4'hA | io_Op == 4'h9
           ? Shifter_1_7
           : io_Op == 4'h8 ? Shifter_1_3 : Shifter_1_5)
      : Shifter_1_5;	// core/src/exu.scala:169:43, :170:53, :185:37, :186:53
  wire Shifter_2_6 =
    io_B[1]
      ? (io_Op == 4'hA | io_Op == 4'h9
           ? Shifter_1_8
           : io_Op == 4'h8 ? Shifter_1_4 : Shifter_1_6)
      : Shifter_1_6;	// core/src/exu.scala:169:43, :170:53, :185:37, :186:53
  wire Shifter_2_7 =
    io_B[1]
      ? (io_Op == 4'hA | io_Op == 4'h9
           ? Shifter_1_9
           : io_Op == 4'h8 ? Shifter_1_5 : Shifter_1_7)
      : Shifter_1_7;	// core/src/exu.scala:169:43, :170:53, :185:37, :186:53
  wire Shifter_2_8 =
    io_B[1]
      ? (io_Op == 4'hA | io_Op == 4'h9
           ? Shifter_1_10
           : io_Op == 4'h8 ? Shifter_1_6 : Shifter_1_8)
      : Shifter_1_8;	// core/src/exu.scala:169:43, :170:53, :185:37, :186:53
  wire Shifter_2_9 =
    io_B[1]
      ? (io_Op == 4'hA | io_Op == 4'h9
           ? Shifter_1_11
           : io_Op == 4'h8 ? Shifter_1_7 : Shifter_1_9)
      : Shifter_1_9;	// core/src/exu.scala:169:43, :170:53, :185:37, :186:53
  wire Shifter_2_10 =
    io_B[1]
      ? (io_Op == 4'hA | io_Op == 4'h9
           ? Shifter_1_12
           : io_Op == 4'h8 ? Shifter_1_8 : Shifter_1_10)
      : Shifter_1_10;	// core/src/exu.scala:169:43, :170:53, :185:37, :186:53
  wire Shifter_2_11 =
    io_B[1]
      ? (io_Op == 4'hA | io_Op == 4'h9
           ? Shifter_1_13
           : io_Op == 4'h8 ? Shifter_1_9 : Shifter_1_11)
      : Shifter_1_11;	// core/src/exu.scala:169:43, :170:53, :185:37, :186:53
  wire Shifter_2_12 =
    io_B[1]
      ? (io_Op == 4'hA | io_Op == 4'h9
           ? Shifter_1_14
           : io_Op == 4'h8 ? Shifter_1_10 : Shifter_1_12)
      : Shifter_1_12;	// core/src/exu.scala:169:43, :170:53, :185:37, :186:53
  wire Shifter_2_13 =
    io_B[1]
      ? (io_Op == 4'hA | io_Op == 4'h9
           ? Shifter_1_15
           : io_Op == 4'h8 ? Shifter_1_11 : Shifter_1_13)
      : Shifter_1_13;	// core/src/exu.scala:169:43, :170:53, :185:37, :186:53
  wire Shifter_2_14 =
    io_B[1]
      ? (io_Op == 4'hA | io_Op == 4'h9
           ? Shifter_1_16
           : io_Op == 4'h8 ? Shifter_1_12 : Shifter_1_14)
      : Shifter_1_14;	// core/src/exu.scala:169:43, :170:53, :185:37, :186:53
  wire Shifter_2_15 =
    io_B[1]
      ? (io_Op == 4'hA | io_Op == 4'h9
           ? Shifter_1_17
           : io_Op == 4'h8 ? Shifter_1_13 : Shifter_1_15)
      : Shifter_1_15;	// core/src/exu.scala:169:43, :170:53, :185:37, :186:53
  wire Shifter_2_16 =
    io_B[1]
      ? (io_Op == 4'hA | io_Op == 4'h9
           ? Shifter_1_18
           : io_Op == 4'h8 ? Shifter_1_14 : Shifter_1_16)
      : Shifter_1_16;	// core/src/exu.scala:169:43, :170:53, :185:37, :186:53
  wire Shifter_2_17 =
    io_B[1]
      ? (io_Op == 4'hA | io_Op == 4'h9
           ? Shifter_1_19
           : io_Op == 4'h8 ? Shifter_1_15 : Shifter_1_17)
      : Shifter_1_17;	// core/src/exu.scala:169:43, :170:53, :185:37, :186:53
  wire Shifter_2_18 =
    io_B[1]
      ? (io_Op == 4'hA | io_Op == 4'h9
           ? Shifter_1_20
           : io_Op == 4'h8 ? Shifter_1_16 : Shifter_1_18)
      : Shifter_1_18;	// core/src/exu.scala:169:43, :170:53, :185:37, :186:53
  wire Shifter_2_19 =
    io_B[1]
      ? (io_Op == 4'hA | io_Op == 4'h9
           ? Shifter_1_21
           : io_Op == 4'h8 ? Shifter_1_17 : Shifter_1_19)
      : Shifter_1_19;	// core/src/exu.scala:169:43, :170:53, :185:37, :186:53
  wire Shifter_2_20 =
    io_B[1]
      ? (io_Op == 4'hA | io_Op == 4'h9
           ? Shifter_1_22
           : io_Op == 4'h8 ? Shifter_1_18 : Shifter_1_20)
      : Shifter_1_20;	// core/src/exu.scala:169:43, :170:53, :185:37, :186:53
  wire Shifter_2_21 =
    io_B[1]
      ? (io_Op == 4'hA | io_Op == 4'h9
           ? Shifter_1_23
           : io_Op == 4'h8 ? Shifter_1_19 : Shifter_1_21)
      : Shifter_1_21;	// core/src/exu.scala:169:43, :170:53, :185:37, :186:53
  wire Shifter_2_22 =
    io_B[1]
      ? (io_Op == 4'hA | io_Op == 4'h9
           ? Shifter_1_24
           : io_Op == 4'h8 ? Shifter_1_20 : Shifter_1_22)
      : Shifter_1_22;	// core/src/exu.scala:169:43, :170:53, :185:37, :186:53
  wire Shifter_2_23 =
    io_B[1]
      ? (io_Op == 4'hA | io_Op == 4'h9
           ? Shifter_1_25
           : io_Op == 4'h8 ? Shifter_1_21 : Shifter_1_23)
      : Shifter_1_23;	// core/src/exu.scala:169:43, :170:53, :185:37, :186:53
  wire Shifter_2_24 =
    io_B[1]
      ? (io_Op == 4'hA | io_Op == 4'h9
           ? Shifter_1_26
           : io_Op == 4'h8 ? Shifter_1_22 : Shifter_1_24)
      : Shifter_1_24;	// core/src/exu.scala:169:43, :170:53, :185:37, :186:53
  wire Shifter_2_25 =
    io_B[1]
      ? (io_Op == 4'hA | io_Op == 4'h9
           ? Shifter_1_27
           : io_Op == 4'h8 ? Shifter_1_23 : Shifter_1_25)
      : Shifter_1_25;	// core/src/exu.scala:169:43, :170:53, :185:37, :186:53
  wire Shifter_2_26 =
    io_B[1]
      ? (io_Op == 4'hA | io_Op == 4'h9
           ? Shifter_1_28
           : io_Op == 4'h8 ? Shifter_1_24 : Shifter_1_26)
      : Shifter_1_26;	// core/src/exu.scala:169:43, :170:53, :185:37, :186:53
  wire Shifter_2_27 =
    io_B[1]
      ? (io_Op == 4'hA | io_Op == 4'h9
           ? Shifter_1_29
           : io_Op == 4'h8 ? Shifter_1_25 : Shifter_1_27)
      : Shifter_1_27;	// core/src/exu.scala:169:43, :170:53, :185:37, :186:53
  wire Shifter_2_28 =
    io_B[1]
      ? (io_Op == 4'hA | io_Op == 4'h9
           ? Shifter_1_30
           : io_Op == 4'h8 ? Shifter_1_26 : Shifter_1_28)
      : Shifter_1_28;	// core/src/exu.scala:169:43, :170:53, :185:37, :186:53
  wire Shifter_2_29 =
    io_B[1]
      ? (io_Op == 4'hA | io_Op == 4'h9
           ? Shifter_1_31
           : io_Op == 4'h8 ? Shifter_1_27 : Shifter_1_29)
      : Shifter_1_29;	// core/src/exu.scala:169:43, :170:53, :177:37, :185:37, :186:53
  wire Shifter_2_30 =
    io_B[1]
      ? (io_Op == 4'hA
           ? io_A[31]
           : _GEN_0 & (io_Op == 4'h8 ? Shifter_1_28 : Shifter_1_30))
      : Shifter_1_30;	// core/src/exu.scala:165:24, :169:43, :170:53, :177:37, :178:53, :185:37
  wire Shifter_2_31 =
    io_B[1]
      ? (io_Op == 4'hA
           ? io_A[31]
           : _GEN_0 & (io_Op == 4'h8 ? Shifter_1_29 : Shifter_1_31))
      : Shifter_1_31;	// core/src/exu.scala:165:24, :169:43, :170:53, :177:37, :178:53, :185:37
  wire Shifter_3_0 =
    io_B[2]
      ? (io_Op == 4'hA | io_Op == 4'h9 ? Shifter_2_4 : _GEN & Shifter_2_0)
      : Shifter_2_0;	// core/src/exu.scala:169:{37,43}, :170:53, :185:37
  wire Shifter_3_1 =
    io_B[2]
      ? (io_Op == 4'hA | io_Op == 4'h9 ? Shifter_2_5 : _GEN & Shifter_2_1)
      : Shifter_2_1;	// core/src/exu.scala:169:{37,43}, :170:53, :185:37
  wire Shifter_3_2 =
    io_B[2]
      ? (io_Op == 4'hA | io_Op == 4'h9 ? Shifter_2_6 : _GEN & Shifter_2_2)
      : Shifter_2_2;	// core/src/exu.scala:169:{37,43}, :170:53, :185:37
  wire Shifter_3_3 =
    io_B[2]
      ? (io_Op == 4'hA | io_Op == 4'h9 ? Shifter_2_7 : _GEN & Shifter_2_3)
      : Shifter_2_3;	// core/src/exu.scala:169:{37,43}, :170:53, :185:37
  wire Shifter_3_4 =
    io_B[2]
      ? (io_Op == 4'hA | io_Op == 4'h9
           ? Shifter_2_8
           : io_Op == 4'h8 ? Shifter_2_0 : Shifter_2_4)
      : Shifter_2_4;	// core/src/exu.scala:169:{37,43}, :170:53, :185:37, :186:53
  wire Shifter_3_5 =
    io_B[2]
      ? (io_Op == 4'hA | io_Op == 4'h9
           ? Shifter_2_9
           : io_Op == 4'h8 ? Shifter_2_1 : Shifter_2_5)
      : Shifter_2_5;	// core/src/exu.scala:169:{37,43}, :170:53, :185:37, :186:53
  wire Shifter_3_6 =
    io_B[2]
      ? (io_Op == 4'hA | io_Op == 4'h9
           ? Shifter_2_10
           : io_Op == 4'h8 ? Shifter_2_2 : Shifter_2_6)
      : Shifter_2_6;	// core/src/exu.scala:169:43, :170:53, :185:37, :186:53
  wire Shifter_3_7 =
    io_B[2]
      ? (io_Op == 4'hA | io_Op == 4'h9
           ? Shifter_2_11
           : io_Op == 4'h8 ? Shifter_2_3 : Shifter_2_7)
      : Shifter_2_7;	// core/src/exu.scala:169:43, :170:53, :185:37, :186:53
  wire Shifter_3_8 =
    io_B[2]
      ? (io_Op == 4'hA | io_Op == 4'h9
           ? Shifter_2_12
           : io_Op == 4'h8 ? Shifter_2_4 : Shifter_2_8)
      : Shifter_2_8;	// core/src/exu.scala:169:43, :170:53, :185:37, :186:53
  wire Shifter_3_9 =
    io_B[2]
      ? (io_Op == 4'hA | io_Op == 4'h9
           ? Shifter_2_13
           : io_Op == 4'h8 ? Shifter_2_5 : Shifter_2_9)
      : Shifter_2_9;	// core/src/exu.scala:169:43, :170:53, :185:37, :186:53
  wire Shifter_3_10 =
    io_B[2]
      ? (io_Op == 4'hA | io_Op == 4'h9
           ? Shifter_2_14
           : io_Op == 4'h8 ? Shifter_2_6 : Shifter_2_10)
      : Shifter_2_10;	// core/src/exu.scala:169:43, :170:53, :185:37, :186:53
  wire Shifter_3_11 =
    io_B[2]
      ? (io_Op == 4'hA | io_Op == 4'h9
           ? Shifter_2_15
           : io_Op == 4'h8 ? Shifter_2_7 : Shifter_2_11)
      : Shifter_2_11;	// core/src/exu.scala:169:43, :170:53, :185:37, :186:53
  wire Shifter_3_12 =
    io_B[2]
      ? (io_Op == 4'hA | io_Op == 4'h9
           ? Shifter_2_16
           : io_Op == 4'h8 ? Shifter_2_8 : Shifter_2_12)
      : Shifter_2_12;	// core/src/exu.scala:169:43, :170:53, :185:37, :186:53
  wire Shifter_3_13 =
    io_B[2]
      ? (io_Op == 4'hA | io_Op == 4'h9
           ? Shifter_2_17
           : io_Op == 4'h8 ? Shifter_2_9 : Shifter_2_13)
      : Shifter_2_13;	// core/src/exu.scala:169:43, :170:53, :185:37, :186:53
  wire Shifter_3_14 =
    io_B[2]
      ? (io_Op == 4'hA | io_Op == 4'h9
           ? Shifter_2_18
           : io_Op == 4'h8 ? Shifter_2_10 : Shifter_2_14)
      : Shifter_2_14;	// core/src/exu.scala:169:43, :170:53, :185:37, :186:53
  wire Shifter_3_15 =
    io_B[2]
      ? (io_Op == 4'hA | io_Op == 4'h9
           ? Shifter_2_19
           : io_Op == 4'h8 ? Shifter_2_11 : Shifter_2_15)
      : Shifter_2_15;	// core/src/exu.scala:169:43, :170:53, :185:37, :186:53
  wire Shifter_3_16 =
    io_B[2]
      ? (io_Op == 4'hA | io_Op == 4'h9
           ? Shifter_2_20
           : io_Op == 4'h8 ? Shifter_2_12 : Shifter_2_16)
      : Shifter_2_16;	// core/src/exu.scala:169:43, :170:53, :185:37, :186:53
  wire Shifter_3_17 =
    io_B[2]
      ? (io_Op == 4'hA | io_Op == 4'h9
           ? Shifter_2_21
           : io_Op == 4'h8 ? Shifter_2_13 : Shifter_2_17)
      : Shifter_2_17;	// core/src/exu.scala:169:43, :170:53, :185:37, :186:53
  wire Shifter_3_18 =
    io_B[2]
      ? (io_Op == 4'hA | io_Op == 4'h9
           ? Shifter_2_22
           : io_Op == 4'h8 ? Shifter_2_14 : Shifter_2_18)
      : Shifter_2_18;	// core/src/exu.scala:169:43, :170:53, :185:37, :186:53
  wire Shifter_3_19 =
    io_B[2]
      ? (io_Op == 4'hA | io_Op == 4'h9
           ? Shifter_2_23
           : io_Op == 4'h8 ? Shifter_2_15 : Shifter_2_19)
      : Shifter_2_19;	// core/src/exu.scala:169:43, :170:53, :185:37, :186:53
  wire Shifter_3_20 =
    io_B[2]
      ? (io_Op == 4'hA | io_Op == 4'h9
           ? Shifter_2_24
           : io_Op == 4'h8 ? Shifter_2_16 : Shifter_2_20)
      : Shifter_2_20;	// core/src/exu.scala:169:43, :170:53, :185:37, :186:53
  wire Shifter_3_21 =
    io_B[2]
      ? (io_Op == 4'hA | io_Op == 4'h9
           ? Shifter_2_25
           : io_Op == 4'h8 ? Shifter_2_17 : Shifter_2_21)
      : Shifter_2_21;	// core/src/exu.scala:169:43, :170:53, :185:37, :186:53
  wire Shifter_3_22 =
    io_B[2]
      ? (io_Op == 4'hA | io_Op == 4'h9
           ? Shifter_2_26
           : io_Op == 4'h8 ? Shifter_2_18 : Shifter_2_22)
      : Shifter_2_22;	// core/src/exu.scala:169:43, :170:53, :185:37, :186:53
  wire Shifter_3_23 =
    io_B[2]
      ? (io_Op == 4'hA | io_Op == 4'h9
           ? Shifter_2_27
           : io_Op == 4'h8 ? Shifter_2_19 : Shifter_2_23)
      : Shifter_2_23;	// core/src/exu.scala:169:43, :170:53, :185:37, :186:53
  wire Shifter_3_24 =
    io_B[2]
      ? (io_Op == 4'hA | io_Op == 4'h9
           ? Shifter_2_28
           : io_Op == 4'h8 ? Shifter_2_20 : Shifter_2_24)
      : Shifter_2_24;	// core/src/exu.scala:169:43, :170:53, :185:37, :186:53
  wire Shifter_3_25 =
    io_B[2]
      ? (io_Op == 4'hA | io_Op == 4'h9
           ? Shifter_2_29
           : io_Op == 4'h8 ? Shifter_2_21 : Shifter_2_25)
      : Shifter_2_25;	// core/src/exu.scala:169:43, :170:53, :185:37, :186:53
  wire Shifter_3_26 =
    io_B[2]
      ? (io_Op == 4'hA | io_Op == 4'h9
           ? Shifter_2_30
           : io_Op == 4'h8 ? Shifter_2_22 : Shifter_2_26)
      : Shifter_2_26;	// core/src/exu.scala:169:43, :170:53, :177:37, :185:37, :186:53
  wire Shifter_3_27 =
    io_B[2]
      ? (io_Op == 4'hA | io_Op == 4'h9
           ? Shifter_2_31
           : io_Op == 4'h8 ? Shifter_2_23 : Shifter_2_27)
      : Shifter_2_27;	// core/src/exu.scala:169:43, :170:53, :177:37, :185:37, :186:53
  wire Shifter_3_28 =
    io_B[2]
      ? (io_Op == 4'hA
           ? io_A[31]
           : _GEN_0 & (io_Op == 4'h8 ? Shifter_2_24 : Shifter_2_28))
      : Shifter_2_28;	// core/src/exu.scala:165:24, :169:43, :170:53, :177:37, :178:53, :185:37
  wire Shifter_3_29 =
    io_B[2]
      ? (io_Op == 4'hA
           ? io_A[31]
           : _GEN_0 & (io_Op == 4'h8 ? Shifter_2_25 : Shifter_2_29))
      : Shifter_2_29;	// core/src/exu.scala:165:24, :169:43, :170:53, :177:37, :178:53, :185:37
  wire Shifter_3_30 =
    io_B[2]
      ? (io_Op == 4'hA
           ? io_A[31]
           : _GEN_0 & (io_Op == 4'h8 ? Shifter_2_26 : Shifter_2_30))
      : Shifter_2_30;	// core/src/exu.scala:165:24, :169:43, :170:53, :177:37, :178:53, :185:37
  wire Shifter_3_31 =
    io_B[2]
      ? (io_Op == 4'hA
           ? io_A[31]
           : _GEN_0 & (io_Op == 4'h8 ? Shifter_2_27 : Shifter_2_31))
      : Shifter_2_31;	// core/src/exu.scala:165:24, :169:43, :170:53, :177:37, :178:53, :185:37
  wire Shifter_4_0 =
    io_B[3]
      ? (io_Op == 4'hA | io_Op == 4'h9 ? Shifter_3_8 : _GEN & Shifter_3_0)
      : Shifter_3_0;	// core/src/exu.scala:169:{37,43}, :170:53, :185:37
  wire Shifter_4_1 =
    io_B[3]
      ? (io_Op == 4'hA | io_Op == 4'h9 ? Shifter_3_9 : _GEN & Shifter_3_1)
      : Shifter_3_1;	// core/src/exu.scala:169:{37,43}, :170:53, :185:37
  wire Shifter_4_2 =
    io_B[3]
      ? (io_Op == 4'hA | io_Op == 4'h9 ? Shifter_3_10 : _GEN & Shifter_3_2)
      : Shifter_3_2;	// core/src/exu.scala:169:{37,43}, :170:53, :185:37
  wire Shifter_4_3 =
    io_B[3]
      ? (io_Op == 4'hA | io_Op == 4'h9 ? Shifter_3_11 : _GEN & Shifter_3_3)
      : Shifter_3_3;	// core/src/exu.scala:169:{37,43}, :170:53, :185:37
  wire Shifter_4_4 =
    io_B[3]
      ? (io_Op == 4'hA | io_Op == 4'h9 ? Shifter_3_12 : _GEN & Shifter_3_4)
      : Shifter_3_4;	// core/src/exu.scala:169:{37,43}, :170:53, :185:37
  wire Shifter_4_5 =
    io_B[3]
      ? (io_Op == 4'hA | io_Op == 4'h9 ? Shifter_3_13 : _GEN & Shifter_3_5)
      : Shifter_3_5;	// core/src/exu.scala:169:{37,43}, :170:53, :185:37
  wire Shifter_4_6 =
    io_B[3]
      ? (io_Op == 4'hA | io_Op == 4'h9 ? Shifter_3_14 : _GEN & Shifter_3_6)
      : Shifter_3_6;	// core/src/exu.scala:169:{37,43}, :170:53, :185:37
  wire Shifter_4_7 =
    io_B[3]
      ? (io_Op == 4'hA | io_Op == 4'h9 ? Shifter_3_15 : _GEN & Shifter_3_7)
      : Shifter_3_7;	// core/src/exu.scala:169:{37,43}, :170:53, :185:37
  wire Shifter_4_8 =
    io_B[3]
      ? (io_Op == 4'hA | io_Op == 4'h9
           ? Shifter_3_16
           : io_Op == 4'h8 ? Shifter_3_0 : Shifter_3_8)
      : Shifter_3_8;	// core/src/exu.scala:169:{37,43}, :170:53, :185:37, :186:53
  wire Shifter_4_9 =
    io_B[3]
      ? (io_Op == 4'hA | io_Op == 4'h9
           ? Shifter_3_17
           : io_Op == 4'h8 ? Shifter_3_1 : Shifter_3_9)
      : Shifter_3_9;	// core/src/exu.scala:169:{37,43}, :170:53, :185:37, :186:53
  wire Shifter_4_10 =
    io_B[3]
      ? (io_Op == 4'hA | io_Op == 4'h9
           ? Shifter_3_18
           : io_Op == 4'h8 ? Shifter_3_2 : Shifter_3_10)
      : Shifter_3_10;	// core/src/exu.scala:169:{37,43}, :170:53, :185:37, :186:53
  wire Shifter_4_11 =
    io_B[3]
      ? (io_Op == 4'hA | io_Op == 4'h9
           ? Shifter_3_19
           : io_Op == 4'h8 ? Shifter_3_3 : Shifter_3_11)
      : Shifter_3_11;	// core/src/exu.scala:169:{37,43}, :170:53, :185:37, :186:53
  wire Shifter_4_12 =
    io_B[3]
      ? (io_Op == 4'hA | io_Op == 4'h9
           ? Shifter_3_20
           : io_Op == 4'h8 ? Shifter_3_4 : Shifter_3_12)
      : Shifter_3_12;	// core/src/exu.scala:169:43, :170:53, :185:37, :186:53
  wire Shifter_4_13 =
    io_B[3]
      ? (io_Op == 4'hA | io_Op == 4'h9
           ? Shifter_3_21
           : io_Op == 4'h8 ? Shifter_3_5 : Shifter_3_13)
      : Shifter_3_13;	// core/src/exu.scala:169:43, :170:53, :185:37, :186:53
  wire Shifter_4_14 =
    io_B[3]
      ? (io_Op == 4'hA | io_Op == 4'h9
           ? Shifter_3_22
           : io_Op == 4'h8 ? Shifter_3_6 : Shifter_3_14)
      : Shifter_3_14;	// core/src/exu.scala:169:43, :170:53, :185:37, :186:53
  wire Shifter_4_15 =
    io_B[3]
      ? (io_Op == 4'hA | io_Op == 4'h9
           ? Shifter_3_23
           : io_Op == 4'h8 ? Shifter_3_7 : Shifter_3_15)
      : Shifter_3_15;	// core/src/exu.scala:169:43, :170:53, :185:37, :186:53
  wire Shifter_4_16 =
    io_B[3]
      ? (io_Op == 4'hA | io_Op == 4'h9
           ? Shifter_3_24
           : io_Op == 4'h8 ? Shifter_3_8 : Shifter_3_16)
      : Shifter_3_16;	// core/src/exu.scala:169:43, :170:53, :185:37, :186:53
  wire Shifter_4_17 =
    io_B[3]
      ? (io_Op == 4'hA | io_Op == 4'h9
           ? Shifter_3_25
           : io_Op == 4'h8 ? Shifter_3_9 : Shifter_3_17)
      : Shifter_3_17;	// core/src/exu.scala:169:43, :170:53, :185:37, :186:53
  wire Shifter_4_18 =
    io_B[3]
      ? (io_Op == 4'hA | io_Op == 4'h9
           ? Shifter_3_26
           : io_Op == 4'h8 ? Shifter_3_10 : Shifter_3_18)
      : Shifter_3_18;	// core/src/exu.scala:169:43, :170:53, :185:37, :186:53
  wire Shifter_4_19 =
    io_B[3]
      ? (io_Op == 4'hA | io_Op == 4'h9
           ? Shifter_3_27
           : io_Op == 4'h8 ? Shifter_3_11 : Shifter_3_19)
      : Shifter_3_19;	// core/src/exu.scala:169:43, :170:53, :185:37, :186:53
  wire Shifter_4_20 =
    io_B[3]
      ? (io_Op == 4'hA | io_Op == 4'h9
           ? Shifter_3_28
           : io_Op == 4'h8 ? Shifter_3_12 : Shifter_3_20)
      : Shifter_3_20;	// core/src/exu.scala:169:43, :170:53, :177:37, :185:37, :186:53
  wire Shifter_4_21 =
    io_B[3]
      ? (io_Op == 4'hA | io_Op == 4'h9
           ? Shifter_3_29
           : io_Op == 4'h8 ? Shifter_3_13 : Shifter_3_21)
      : Shifter_3_21;	// core/src/exu.scala:169:43, :170:53, :177:37, :185:37, :186:53
  wire Shifter_4_22 =
    io_B[3]
      ? (io_Op == 4'hA | io_Op == 4'h9
           ? Shifter_3_30
           : io_Op == 4'h8 ? Shifter_3_14 : Shifter_3_22)
      : Shifter_3_22;	// core/src/exu.scala:169:43, :170:53, :177:37, :185:37, :186:53
  wire Shifter_4_23 =
    io_B[3]
      ? (io_Op == 4'hA | io_Op == 4'h9
           ? Shifter_3_31
           : io_Op == 4'h8 ? Shifter_3_15 : Shifter_3_23)
      : Shifter_3_23;	// core/src/exu.scala:169:43, :170:53, :177:37, :185:37, :186:53
  wire Shifter_4_24 =
    io_B[3]
      ? (io_Op == 4'hA
           ? io_A[31]
           : _GEN_0 & (io_Op == 4'h8 ? Shifter_3_16 : Shifter_3_24))
      : Shifter_3_24;	// core/src/exu.scala:165:24, :169:43, :170:53, :177:37, :178:53, :185:37
  wire Shifter_4_25 =
    io_B[3]
      ? (io_Op == 4'hA
           ? io_A[31]
           : _GEN_0 & (io_Op == 4'h8 ? Shifter_3_17 : Shifter_3_25))
      : Shifter_3_25;	// core/src/exu.scala:165:24, :169:43, :170:53, :177:37, :178:53, :185:37
  wire Shifter_4_26 =
    io_B[3]
      ? (io_Op == 4'hA
           ? io_A[31]
           : _GEN_0 & (io_Op == 4'h8 ? Shifter_3_18 : Shifter_3_26))
      : Shifter_3_26;	// core/src/exu.scala:165:24, :169:43, :170:53, :177:37, :178:53, :185:37
  wire Shifter_4_27 =
    io_B[3]
      ? (io_Op == 4'hA
           ? io_A[31]
           : _GEN_0 & (io_Op == 4'h8 ? Shifter_3_19 : Shifter_3_27))
      : Shifter_3_27;	// core/src/exu.scala:165:24, :169:43, :170:53, :177:37, :178:53, :185:37
  wire Shifter_4_28 =
    io_B[3]
      ? (io_Op == 4'hA
           ? io_A[31]
           : _GEN_0 & (io_Op == 4'h8 ? Shifter_3_20 : Shifter_3_28))
      : Shifter_3_28;	// core/src/exu.scala:165:24, :169:43, :170:53, :177:37, :178:53, :185:37
  wire Shifter_4_29 =
    io_B[3]
      ? (io_Op == 4'hA
           ? io_A[31]
           : _GEN_0 & (io_Op == 4'h8 ? Shifter_3_21 : Shifter_3_29))
      : Shifter_3_29;	// core/src/exu.scala:165:24, :169:43, :170:53, :177:37, :178:53, :185:37
  wire Shifter_4_30 =
    io_B[3]
      ? (io_Op == 4'hA
           ? io_A[31]
           : _GEN_0 & (io_Op == 4'h8 ? Shifter_3_22 : Shifter_3_30))
      : Shifter_3_30;	// core/src/exu.scala:165:24, :169:43, :170:53, :177:37, :178:53, :185:37
  wire Shifter_4_31 =
    io_B[3]
      ? (io_Op == 4'hA
           ? io_A[31]
           : _GEN_0 & (io_Op == 4'h8 ? Shifter_3_23 : Shifter_3_31))
      : Shifter_3_31;	// core/src/exu.scala:165:24, :169:43, :170:53, :177:37, :178:53, :185:37
  assign io_Out =
    {io_B[4]
       ? (io_Op == 4'hA
            ? io_A[31]
     ...
     io_B[4]
       ...
       : Shifter_4_0};	// core/src/exu.scala:156:7, :165:24, :169:{37,43}, :170:53, :177:37, :178:53, :185:37, :194:26
endmodule

(*DONT_TOUCH="TRUE"*)module alu(	// core/src/exu.scala:107:7
  input  [31:0] io_A,	// core/src/exu.scala:108:16
                io_B,	// core/src/exu.scala:108:16
  input  [3:0]  io_Op,	// core/src/exu.scala:108:16
  output [31:0] io_Out,	// core/src/exu.scala:108:16
  output        io_ULess,	// core/src/exu.scala:108:16
                io_SLess,	// core/src/exu.scala:108:16
                io_Zero	// core/src/exu.scala:108:16
);

  wire [31:0]       _Shifter_io_Out;	// core/src/exu.scala:133:25
  wire              Sub = io_Op == 4'h3 | io_Op == 4'h2 | io_Op == 4'h1;	// core/src/exu.scala:118:37
  wire [31:0]       FixB = io_B ^ {32{Sub}};	// core/src/exu.scala:118:37, :126:{21,27}
  wire [33:0]       FixSum = {1'h0, {1'h0, io_A} + {1'h0, FixB}} + {33'h0, Sub};	// core/src/exu.scala:118:37, :126:21, :127:{23,31}
  wire              SLess = FixSum[31] ^ io_A[31] == FixB[31] & FixSum[31] != io_A[31];	// core/src/exu.scala:126:21, :127:31, :128:{19,24,32,38,48,53}, :130:29
  wire [31:0]       _io_Out_T_5 = io_A | io_B;	// core/src/exu.scala:144:27
  wire [33:0]       _GEN = {2'h0, _Shifter_io_Out};	// core/src/exu.scala:118:37, :133:25, :138:37
  wire [15:0][33:0] _GEN_0 =
    {{34'h0},
     ...
     {{33'h0, SLess}},
     {FixSum},
     {FixSum}};	// core/src/exu.scala:118:37, :127:31, :130:29, :131:{17,24}, :138:37, :143:28, :144:27, :145:28, :146:22
  bshifter Shifter (	// core/src/exu.scala:133:25
    .io_A   (io_A),
    .io_B   (io_B[4:0]),	// core/src/exu.scala:135:25
    .io_Op  (io_Op),
    .io_Out (_Shifter_io_Out)
  );
  assign io_Out = _GEN_0[io_Op][31:0];	// core/src/exu.scala:107:7, :138:{12,37}
  assign io_ULess = ~(FixSum[32]);	// core/src/exu.scala:107:7, :127:31, :131:{17,24}
  assign io_SLess = SLess;	// core/src/exu.scala:107:7, :130:29
  assign io_Zero = FixSum[31:0] == 32'h0;	// core/src/exu.scala:107:7, :126:27, :127:31, :129:{21,29}
endmodule

(*DONT_TOUCH="TRUE"*)module branchContr(	// core/src/exu.scala:76:7
  input  [31:0] io_pc,	// core/src/exu.scala:77:16
                io_rj_data,	// core/src/exu.scala:77:16
                io_offset,	// core/src/exu.scala:77:16
  input  [3:0]  io_branchOp,	// core/src/exu.scala:77:16
  input         io_SLess,	// core/src/exu.scala:77:16
                io_ULess,	// core/src/exu.scala:77:16
                io_Zero,	// core/src/exu.scala:77:16
  output [31:0] io_nextPC	// core/src/exu.scala:77:16
);
                 ...
                 : io_branchOp == 4'h3
                     ...
                     : io_branchOp == 4'h2
                         ...
                         : io_branchOp == 4'h1
                             ...
                             : io_branchOp == 4'h0 & io_Zero ? io_offset : 32'h4);	// core/src/exu.scala:76:7, :88:48, :92:46, :93:26, :94:26, :95:26, :96:26, :97:27, :98:27, :104:25
endmodule
...
(*DONT_TOUCH="TRUE"*)module exu(	// core/src/exu.scala:5:7
  ...
  output [31:0] io_next_bits_rd_data,	// core/src/exu.scala:6:16
                io_next_bits_nextPC,	// core/src/exu.scala:6:16
  ...
  wire        _ALU_io_ULess;	// core/src/exu.scala:21:21
  wire        _ALU_io_SLess;	// core/src/exu.scala:21:21
  wire        _ALU_io_Zero;	// core/src/exu.scala:21:21
    ...
    io_prev_bits_FwEX_RD == 3'h3
      ...
      : io_prev_bits_FwEX_RD == 3'h2
          ...
          : io_prev_bits_FwEX_RD == 3'h1
              ? io_LWALU
              : io_prev_bits_FwEX_RD == 3'h0 ? io_ELALU : io_prev_bits_rd_data;	// core/src/exu.scala:20:22, :31:75
  wire [31:0] ForwardRJ =
    io_prev_bits_FwEX_RJ == 3'h3
      ...
      : io_prev_bits_FwEX_RJ == 3'h2
          ...
          : io_prev_bits_FwEX_RJ == 3'h1
              ? io_LWALU
              : io_prev_bits_FwEX_RJ == 3'h0 ? io_ELALU : io_prev_bits_rj_data;	// core/src/exu.scala:20:22, :31:75, :32:75
  wire [31:0] ALUA =
    io_prev_bits_aluAsrc == 2'h1
      ? io_prev_bits_pc
      : io_prev_bits_aluAsrc == 2'h0 ? ForwardRJ : 32'h0;	// core/src/exu.scala:31:75, :32:75, :35:53
  wire [31:0] ALUB =
      ...
      : io_prev_bits_aluBsrc == 3'h2
          ...
          : io_prev_bits_aluBsrc == 3'h1
              ...
              : io_prev_bits_aluBsrc == 3'h0
                  ...
                  : 32'h0;	// core/src/exu.scala:20:22, :31:75, :33:75, :35:53, :39:53
  mult_gen_0 mult (	// core/src/exu.scala:20:22
    .CLK (clock),
    .A   (ALUA),	// core/src/exu.scala:35:53
    .B   (ALUB),	// core/src/exu.scala:39:53
    .P   (_mult_P)
  );
  alu ALU (	// core/src/exu.scala:21:21
    .io_A     (ALUA),	// core/src/exu.scala:35:53
    .io_B     (ALUB),	// core/src/exu.scala:39:53
  ...
  branchContr brCtrl (	// core/src/exu.scala:22:24
    .io_pc       (io_prev_bits_pc),
    .io_rj_data  (ForwardRJ),	// core/src/exu.scala:32:75
    .io_offset   (io_prev_bits_Imm),
    .io_branchOp (io_prev_bits_branchOp),
    .io_SLess    (_ALU_io_SLess),	// core/src/exu.scala:21:21
    .io_ULess    (_ALU_io_ULess),	// core/src/exu.scala:21:21
    .io_Zero     (_ALU_io_Zero),	// core/src/exu.scala:21:21
    .io_nextPC   (io_next_bits_nextPC)
  );
  assign io_next_valid = io_prev_valid & ~io_flush;	// core/src/exu.scala:5:7, :72:{56,68}
  ...
  assign io_next_bits_rd_data = ForwardRD;	// core/src/exu.scala:5:7, :31:75
  assign io_P = _mult_P;	// core/src/exu.scala:5:7, :20:22
endmodule

(*DONT_TOUCH="TRUE"*)module buffer_2(	// core/src/core.scala:94:7
  input         clock,	// core/src/core.scala:94:7
                reset,	// core/src/core.scala:94:7
                io_prev_valid,	// core/src/core.scala:95:16
  input  [31:0] io_prev_bits_ALUOut,	// core/src/core.scala:95:16
  input  [3:0]  io_prev_bits_memOp,	// core/src/core.scala:95:16
  input  [1:0]  io_prev_bits_wbSel,	// core/src/core.scala:95:16
                io_prev_bits_wbDst,	// core/src/core.scala:95:16
  input  [4:0]  io_prev_bits_rd,	// core/src/core.scala:95:16
  input  [31:0] io_prev_bits_rd_data,	// core/src/core.scala:95:16
                io_prev_bits_nextPC,	// core/src/core.scala:95:16
  output        io_next_valid,	// core/src/core.scala:95:16
  output [31:0] io_next_bits_ALUOut,	// core/src/core.scala:95:16
  output [3:0]  io_next_bits_memOp,	// core/src/core.scala:95:16
  output [1:0]  io_next_bits_wbSel,	// core/src/core.scala:95:16
                io_next_bits_wbDst,	// core/src/core.scala:95:16
  output [4:0]  io_next_bits_rd,	// core/src/core.scala:95:16
  output [31:0] io_next_bits_rd_data,	// core/src/core.scala:95:16
                io_next_bits_nextPC	// core/src/core.scala:95:16
);

  reg        state;	// core/src/core.scala:101:24
  reg [31:0] regs_ALUOut;	// core/src/core.scala:102:19
  reg [3:0]  regs_memOp;	// core/src/core.scala:102:19
  reg [1:0]  regs_wbSel;	// core/src/core.scala:102:19
  reg [1:0]  regs_wbDst;	// core/src/core.scala:102:19
  reg [4:0]  regs_rd;	// core/src/core.scala:102:19
  reg [31:0] regs_rd_data;	// core/src/core.scala:102:19
  reg [31:0] regs_nextPC;	// core/src/core.scala:102:19
  always @(posedge clock) begin	// core/src/core.scala:94:7
    if (reset)	// core/src/core.scala:94:7
      state <= 1'h0;	// core/src/core.scala:95:16, :101:24
    else	// core/src/core.scala:94:7
      state <= io_prev_valid;	// core/src/core.scala:101:24
    regs_ALUOut <= io_prev_valid ? io_prev_bits_ALUOut : 32'h0;	// core/src/core.scala:102:19, :107:29, :113:30, :115:14, :119:14
    regs_memOp <= io_prev_valid ? io_prev_bits_memOp : 4'h0;	// core/src/core.scala:102:19, :107:29, :113:30, :115:14, :119:14
    regs_wbSel <= io_prev_valid ? io_prev_bits_wbSel : 2'h0;	// core/src/core.scala:94:7, :102:19, :113:30, :115:14, :119:14
    regs_wbDst <= io_prev_valid ? io_prev_bits_wbDst : 2'h0;	// core/src/core.scala:94:7, :102:19, :113:30, :115:14, :119:14
    regs_rd <= io_prev_valid ? io_prev_bits_rd : 5'h0;	// core/src/core.scala:102:19, :107:29, :113:30, :115:14, :119:14
    regs_rd_data <= io_prev_valid ? io_prev_bits_rd_data : 32'h0;	// core/src/core.scala:102:19, :107:29, :113:30, :115:14, :119:14
    regs_nextPC <= io_prev_valid ? io_prev_bits_nextPC : 32'h0;	// core/src/core.scala:102:19, :107:29, :113:30, :115:14, :119:14
  end // always @(posedge)
  `ifdef ENABLE_INITIAL_REG_	// core/src/core.scala:94:7
    `ifdef FIRRTL_BEFORE_INITIAL	// core/src/core.scala:94:7
      `FIRRTL_BEFORE_INITIAL	// core/src/core.scala:94:7
    `endif // FIRRTL_BEFORE_INITIAL
    initial begin	// core/src/core.scala:94:7
      automatic logic [31:0] _RANDOM[0:3];	// core/src/core.scala:94:7
      `ifdef INIT_RANDOM_PROLOG_	// core/src/core.scala:94:7
        `INIT_RANDOM_PROLOG_	// core/src/core.scala:94:7
      `endif // INIT_RANDOM_PROLOG_
      `ifdef RANDOMIZE_REG_INIT	// core/src/core.scala:94:7
        for (logic [2:0] i = 3'h0; i < 3'h4; i += 3'h1) begin
          _RANDOM[i[1:0]] = `RANDOM;	// core/src/core.scala:94:7
        end	// core/src/core.scala:94:7
        state = _RANDOM[2'h0][0];	// core/src/core.scala:94:7, :101:24
        regs_ALUOut = {_RANDOM[2'h0][31:1], _RANDOM[2'h1][0]};	// core/src/core.scala:94:7, :101:24, :102:19
        regs_memOp = _RANDOM[2'h1][4:1];	// core/src/core.scala:94:7, :102:19
        regs_wbSel = _RANDOM[2'h1][6:5];	// core/src/core.scala:94:7, :102:19
        regs_wbDst = _RANDOM[2'h1][8:7];	// core/src/core.scala:94:7, :102:19
        regs_rd = _RANDOM[2'h1][13:9];	// core/src/core.scala:94:7, :102:19
        regs_rd_data = {_RANDOM[2'h1][31:14], _RANDOM[2'h2][13:0]};	// core/src/core.scala:94:7, :102:19
        regs_nextPC = {_RANDOM[2'h2][31:14], _RANDOM[2'h3][13:0]};	// core/src/core.scala:94:7, :102:19
      `endif // RANDOMIZE_REG_INIT
    end // initial
    `ifdef FIRRTL_AFTER_INITIAL	// core/src/core.scala:94:7
      `FIRRTL_AFTER_INITIAL	// core/src/core.scala:94:7
  ...
  `endif // ENABLE_INITIAL_REG_
  assign io_next_valid = state;	// core/src/core.scala:94:7, :101:24
  assign io_next_bits_ALUOut = regs_ALUOut;	// core/src/core.scala:94:7, :102:19
  assign io_next_bits_memOp = regs_memOp;	// core/src/core.scala:94:7, :102:19
  assign io_next_bits_wbSel = regs_wbSel;	// core/src/core.scala:94:7, :102:19
  assign io_next_bits_wbDst = regs_wbDst;	// core/src/core.scala:94:7, :102:19
  assign io_next_bits_rd = regs_rd;	// core/src/core.scala:94:7, :102:19
  assign io_next_bits_rd_data = regs_rd_data;	// core/src/core.scala:94:7, :102:19
  assign io_next_bits_nextPC = regs_nextPC;	// core/src/core.scala:94:7, :102:19
endmodule
...
(*DONT_TOUCH="TRUE"*)module lsu(	// core/src/lsu.scala:5:7
  ...
  input  [31:0] io_prev_bits_rd_data,	// core/src/lsu.scala:6:16
                io_prev_bits_nextPC,	// core/src/lsu.scala:6:16
  ...
  assign io_ext_out_valid = io_prev_bits_memOp != 4'h8 & io_prev_valid;	// core/src/lsu.scala:5:7, :117:{44,60}
  ...
  assign io_nextPC = io_prev_bits_nextPC;	// core/src/lsu.scala:5:7
endmodule

(*DONT_TOUCH="TRUE"*)module buffer_3(	// core/src/core.scala:94:7
  input         clock,	// core/src/core.scala:94:7
                reset,	// core/src/core.scala:94:7
                io_prev_valid,	// core/src/core.scala:95:16
  input  [31:0] io_prev_bits_MemOut,	// core/src/core.scala:95:16
                io_prev_bits_ALUOut,	// core/src/core.scala:95:16
  input  [1:0]  io_prev_bits_wbSel,	// core/src/core.scala:95:16
                io_prev_bits_wbDst,	// core/src/core.scala:95:16
  input  [4:0]  io_prev_bits_rd,	// core/src/core.scala:95:16
  output        io_next_valid,	// core/src/core.scala:95:16
  output [31:0] io_next_bits_MemOut,	// core/src/core.scala:95:16
                io_next_bits_ALUOut,	// core/src/core.scala:95:16
  output [1:0]  io_next_bits_wbSel,	// core/src/core.scala:95:16
                io_next_bits_wbDst,	// core/src/core.scala:95:16
  output [4:0]  io_next_bits_rd	// core/src/core.scala:95:16
);
  ...
  reg        state;	// core/src/core.scala:101:24
  reg [31:0] regs_MemOut;	// core/src/core.scala:102:19
  reg [31:0] regs_ALUOut;	// core/src/core.scala:102:19
  reg [1:0]  regs_wbSel;	// core/src/core.scala:102:19
  reg [1:0]  regs_wbDst;	// core/src/core.scala:102:19
  reg [4:0]  regs_rd;	// core/src/core.scala:102:19
  always @(posedge clock) begin	// core/src/core.scala:94:7
    if (reset)	// core/src/core.scala:94:7
      ...
      state <= io_prev_valid;	// core/src/core.scala:101:24
    regs_MemOut <= io_prev_valid ? io_prev_bits_MemOut : 32'h0;	// core/src/core.scala:102:19, :107:29, :113:30, :115:14, :119:14
    regs_ALUOut <= io_prev_valid ? io_prev_bits_ALUOut : 32'h0;	// core/src/core.scala:102:19, :107:29, :113:30, :115:14, :119:14
    regs_wbSel <= io_prev_valid ? io_prev_bits_wbSel : 2'h0;	// core/src/core.scala:94:7, :102:19, :113:30, :115:14, :119:14
    regs_wbDst <= io_prev_valid ? io_prev_bits_wbDst : 2'h0;	// core/src/core.scala:94:7, :102:19, :113:30, :115:14, :119:14
    regs_rd <= io_prev_valid ? io_prev_bits_rd : 5'h0;	// core/src/core.scala:102:19, :107:29, :113:30, :115:14, :119:14
  ...
  `ifdef ENABLE_INITIAL_REG_	// core/src/core.scala:94:7
    ...
    initial begin	// core/src/core.scala:94:7
      ...
      `ifdef RANDOMIZE_REG_INIT	// core/src/core.scala:94:7
        ...
        state = _RANDOM[2'h0][0];	// core/src/core.scala:94:7, :101:24
        regs_MemOut = {_RANDOM[2'h0][31:1], _RANDOM[2'h1][0]};	// core/src/core.scala:94:7, :101:24, :102:19
        regs_ALUOut = {_RANDOM[2'h1][31:1], _RANDOM[2'h2][0]};	// core/src/core.scala:94:7, :102:19
        regs_wbSel = _RANDOM[2'h2][2:1];	// core/src/core.scala:94:7, :102:19
        regs_wbDst = _RANDOM[2'h2][4:3];	// core/src/core.scala:94:7, :102:19
        regs_rd = _RANDOM[2'h2][9:5];	// core/src/core.scala:94:7, :102:19
      `endif // RANDOMIZE_REG_INIT
    end // initial
    `ifdef FIRRTL_AFTER_INITIAL	// core/src/core.scala:94:7
      `FIRRTL_AFTER_INITIAL	// core/src/core.scala:94:7
  ...
  `endif // ENABLE_INITIAL_REG_
  assign io_next_valid = state;	// core/src/core.scala:94:7, :101:24
  assign io_next_bits_MemOut = regs_MemOut;	// core/src/core.scala:94:7, :102:19
  assign io_next_bits_ALUOut = regs_ALUOut;	// core/src/core.scala:94:7, :102:19
  assign io_next_bits_wbSel = regs_wbSel;	// core/src/core.scala:94:7, :102:19
  assign io_next_bits_wbDst = regs_wbDst;	// core/src/core.scala:94:7, :102:19
  assign io_next_bits_rd = regs_rd;	// core/src/core.scala:94:7, :102:19
...
(*DONT_TOUCH="TRUE"*)module Arbiter2_bus_out(	// src/main/scala/chisel3/util/Arbiter.scala:133:7
  ...
  input  [31:0] io_in_0_bits_data_in,	// src/main/scala/chisel3/util/Arbiter.scala:140:14
                io_in_0_bits_addr,	// src/main/scala/chisel3/util/Arbiter.scala:140:14
  input  [3:0]  io_in_0_bits_be_n,	// src/main/scala/chisel3/util/Arbiter.scala:140:14
  input         io_in_0_bits_ce_n,	// src/main/scala/chisel3/util/Arbiter.scala:140:14
                ...
                io_in_0_bits_we_n,	// src/main/scala/chisel3/util/Arbiter.scala:140:14
  ...
  assign io_out_bits_data_wen = io_in_0_valid & io_in_0_bits_data_wen;	// src/main/scala/chisel3/util/Arbiter.scala:133:7, :143:15, :145:26, :147:19
  assign io_out_bits_data_in = io_in_0_valid ? io_in_0_bits_data_in : 32'h0;	// src/main/scala/chisel3/util/Arbiter.scala:133:7, :140:14, :143:15, :145:26, :147:19
  ...
  assign io_out_bits_be_n = io_in_0_valid ? io_in_0_bits_be_n : 4'h0;	// src/main/scala/chisel3/util/Arbiter.scala:133:7, :140:14, :143:15, :145:26, :147:19
  assign io_out_bits_ce_n = io_in_0_valid & io_in_0_bits_ce_n;	// src/main/scala/chisel3/util/Arbiter.scala:133:7, :143:15, :145:26, :147:19
  assign io_out_bits_oe_n = io_in_0_valid & io_in_0_bits_oe_n;	// src/main/scala/chisel3/util/Arbiter.scala:133:7, :143:15, :145:26, :147:19
...
(*DONT_TOUCH="TRUE"*)module abt(	// core/src/abt.scala:5:7
  ...
  input  [31:0] io_in_DataIn_0_bits_data_in,	// core/src/abt.scala:6:16
                io_in_DataIn_0_bits_addr,	// core/src/abt.scala:6:16
  input  [3:0]  io_in_DataIn_0_bits_be_n,	// core/src/abt.scala:6:16
  input         io_in_DataIn_0_bits_ce_n,	// core/src/abt.scala:6:16
                io_in_DataIn_0_bits_oe_n,	// core/src/abt.scala:6:16
                io_in_DataIn_0_bits_we_n,	// core/src/abt.scala:6:16
  output        io_in_DataIn_1_ready,	// core/src/abt.scala:6:16
  input         io_in_DataIn_1_valid,	// core/src/abt.scala:6:16
  input  [31:0] io_in_DataIn_1_bits_addr,	// core/src/abt.scala:6:16
                io_in_BusIn_bits_data_out,	// core/src/abt.scala:6:16
  ...
  Arbiter2_bus_out arbiter (	// core/src/abt.scala:17:25
    ...
    .io_in_0_bits_data_wen (io_in_DataIn_0_bits_data_wen),
    .io_in_0_bits_data_in  (io_in_DataIn_0_bits_data_in),
    .io_in_0_bits_addr     (io_in_DataIn_0_bits_addr),
    .io_in_0_bits_be_n     (io_in_DataIn_0_bits_be_n),
    .io_in_0_bits_ce_n     (io_in_DataIn_0_bits_ce_n),
    .io_in_0_bits_oe_n     (io_in_DataIn_0_bits_oe_n),
    .io_in_0_bits_we_n     (io_in_DataIn_0_bits_we_n),
    .io_in_1_ready         (io_in_DataIn_1_ready),
...
(*DONT_TOUCH="TRUE"*)module core(	// core/src/core.scala:5:7
  ...
  wire        _fwctrl_io_stall;	// core/src/core.scala:41:24
  wire [2:0]  _fwctrl_io_FwID_RJ;	// core/src/core.scala:41:24
  wire [2:0]  _fwctrl_io_FwID_RK;	// core/src/core.scala:41:24
  wire [2:0]  _fwctrl_io_FwID_RD;	// core/src/core.scala:41:24
  wire [2:0]  _fwctrl_io_FwEX_RJ;	// core/src/core.scala:41:24
  wire [2:0]  _fwctrl_io_FwEX_RK;	// core/src/core.scala:41:24
  wire [2:0]  _fwctrl_io_FwEX_RD;	// core/src/core.scala:41:24
  wire        _abt_io_in_DataIn_1_ready;	// core/src/core.scala:20:21
  wire [31:0] _abt_io_out_BusOut_0_bits_data_out;	// core/src/core.scala:20:21
  wire [31:0] _abt_io_out_BusOut_1_bits_data_out;	// core/src/core.scala:20:21
  ...
  wire [31:0] _lsu_io_nextPC;	// core/src/core.scala:16:21
  ...
  wire [31:0] _exu_lsu_io_next_bits_nextPC;	// core/src/core.scala:15:25
  ...
  wire [31:0] _exu_io_next_bits_nextPC;	// core/src/core.scala:14:21
  wire [31:0] _exu_io_P;	// core/src/core.scala:14:21
  ...
  wire [3:0]  _idu_exu_io_next_bits_branchOp;	// core/src/core.scala:13:25
  ...
  wire [2:0]  _idu_exu_io_next_bits_FwEX_RD;	// core/src/core.scala:13:25
  wire [2:0]  _idu_exu_io_next_bits_FwEX_RJ;	// core/src/core.scala:13:25
  wire [2:0]  _idu_exu_io_next_bits_FwEX_RK;	// core/src/core.scala:13:25
  ...
  wire [3:0]  _idu_io_next_bits_branchOp;	// core/src/core.scala:12:21
  ...
  wire [2:0]  _idu_io_next_bits_FwEX_RD;	// core/src/core.scala:12:21
  wire [2:0]  _idu_io_next_bits_FwEX_RJ;	// core/src/core.scala:12:21
  wire [2:0]  _idu_io_next_bits_FwEX_RK;	// core/src/core.scala:12:21
  wire [31:0] _idu_io_next_bits_pc;	// core/src/core.scala:12:21
  wire [4:0]  _idu_io_RJ;	// core/src/core.scala:12:21
  wire [4:0]  _idu_io_RK;	// core/src/core.scala:12:21
  wire [4:0]  _idu_io_RD;	// core/src/core.scala:12:21
  wire [4:0]  _idu_io_RDst;	// core/src/core.scala:12:21
  wire [1:0]  _idu_io_RSel;	// core/src/core.scala:12:21
  wire        _ifu_idu_io_prev_ready;	// core/src/core.scala:11:25
  ...
  wire        flush =
    (_idu_exu_io_next_valid
       ? _idu_exu_io_next_bits_pc
       : _ifu_idu_io_next_valid
           ? _ifu_idu_io_next_bits_pc
           : _ifu_io_next_bits_pc) != _exu_lsu_io_next_bits_nextPC
    & _exu_lsu_io_next_valid;	// core/src/core.scala:10:21, :11:25, :13:25, :15:25, :30:29, :31:16, :33:34, :34:16, :37:16, :39:{24,52}
  ifu ifu (	// core/src/core.scala:10:21
    .clock                    (clock),
    .reset                    (reset),
    .io_base_in_bits_data_out (_abt_io_out_BusOut_1_bits_data_out),	// core/src/core.scala:20:21
    .io_base_out_ready        (_abt_io_in_DataIn_1_ready),	// core/src/core.scala:20:21
    .io_base_out_valid        (_ifu_io_base_out_valid),
    .io_base_out_bits_addr    (_ifu_io_base_out_bits_addr),
    .io_next_ready            (_ifu_idu_io_prev_ready),	// core/src/core.scala:11:25
    .io_next_valid            (_ifu_io_next_valid),
    .io_next_bits_pc          (_ifu_io_next_bits_pc),
    .io_next_bits_inst        (_ifu_io_next_bits_inst),
    .io_flush                 (flush),	// core/src/core.scala:39:52
    .io_nextPC                (_lsu_io_nextPC)	// core/src/core.scala:16:21
  );
  buffer ifu_idu (	// core/src/core.scala:11:25
    ...
    .io_stall          (_fwctrl_io_stall),	// core/src/core.scala:41:24
    .io_flush          (flush)	// core/src/core.scala:39:52
  );
  idu idu (	// core/src/core.scala:12:21
    ...
    .io_FwID_RJ            (_fwctrl_io_FwID_RJ),	// core/src/core.scala:41:24
    .io_FwID_RK            (_fwctrl_io_FwID_RK),	// core/src/core.scala:41:24
    .io_FwID_RD            (_fwctrl_io_FwID_RD),	// core/src/core.scala:41:24
    .io_FwEX_RJ            (_fwctrl_io_FwEX_RJ),	// core/src/core.scala:41:24
    .io_FwEX_RK            (_fwctrl_io_FwEX_RK),	// core/src/core.scala:41:24
    .io_FwEX_RD            (_fwctrl_io_FwEX_RD),	// core/src/core.scala:41:24
    .io_ELALU              (_exu_lsu_io_next_bits_ALUOut),	// core/src/core.scala:15:25
    .io_LWALU              (_lsu_wbu_io_next_bits_ALUOut),	// core/src/core.scala:17:25
    .io_LWMEM              (_lsu_wbu_io_next_bits_MemOut),	// core/src/core.scala:17:25
    .io_MULP               (_exu_io_P)	// core/src/core.scala:14:21
  );
  buffer_1 idu_exu (	// core/src/core.scala:13:25
    ...
    .io_prev_bits_branchOp (_idu_io_next_bits_branchOp),	// core/src/core.scala:12:21
    ...
    .io_prev_bits_FwEX_RD  (_idu_io_next_bits_FwEX_RD),	// core/src/core.scala:12:21
    .io_prev_bits_FwEX_RJ  (_idu_io_next_bits_FwEX_RJ),	// core/src/core.scala:12:21
    .io_prev_bits_FwEX_RK  (_idu_io_next_bits_FwEX_RK),	// core/src/core.scala:12:21
  ...
  exu exu (	// core/src/core.scala:14:21
    ...
    .io_prev_bits_branchOp (_idu_exu_io_next_bits_branchOp),	// core/src/core.scala:13:25
    ...
    .io_prev_bits_FwEX_RD  (_idu_exu_io_next_bits_FwEX_RD),	// core/src/core.scala:13:25
    .io_prev_bits_FwEX_RJ  (_idu_exu_io_next_bits_FwEX_RJ),	// core/src/core.scala:13:25
    .io_prev_bits_FwEX_RK  (_idu_exu_io_next_bits_FwEX_RK),	// core/src/core.scala:13:25
    ...
    .io_next_bits_nextPC   (_exu_io_next_bits_nextPC),
    .io_flush              (flush),	// core/src/core.scala:39:52
    .io_P                  (_exu_io_P),
    .io_ELALU              (_exu_lsu_io_next_bits_ALUOut),	// core/src/core.scala:15:25
    .io_LWALU              (_lsu_wbu_io_next_bits_ALUOut),	// core/src/core.scala:17:25
  ...
  buffer_2 exu_lsu (	// core/src/core.scala:15:25
    ...
    .io_prev_bits_nextPC  (_exu_io_next_bits_nextPC),	// core/src/core.scala:14:21
    ...
    .io_next_bits_nextPC  (_exu_lsu_io_next_bits_nextPC)
  );
  lsu lsu (	// core/src/core.scala:16:21
    .io_ext_in_bits_data_out  (_abt_io_out_BusOut_0_bits_data_out),	// core/src/core.scala:20:21
    ...
    .io_prev_bits_nextPC      (_exu_lsu_io_next_bits_nextPC),	// core/src/core.scala:15:25
  ...
  wbu wbu (	// core/src/core.scala:18:21
    ...
    .io_P                (_exu_io_P)	// core/src/core.scala:14:21
  );
  abt abt (	// core/src/core.scala:20:21
    .io_in_DataIn_0_valid          (_lsu_io_ext_out_valid),	// core/src/core.scala:16:21
    .io_in_DataIn_0_bits_data_wen  (_lsu_io_ext_out_bits_data_wen),	// core/src/core.scala:16:21
    .io_in_DataIn_0_bits_data_in   (_lsu_io_ext_out_bits_data_in),	// core/src/core.scala:16:21
    .io_in_DataIn_0_bits_addr      (_lsu_io_ext_out_bits_addr),	// core/src/core.scala:16:21
    .io_in_DataIn_0_bits_be_n      (_lsu_io_ext_out_bits_be_n),	// core/src/core.scala:16:21
    .io_in_DataIn_0_bits_ce_n      (_lsu_io_ext_out_bits_ce_n),	// core/src/core.scala:16:21
    .io_in_DataIn_0_bits_oe_n      (_lsu_io_ext_out_bits_oe_n),	// core/src/core.scala:16:21
    .io_in_DataIn_0_bits_we_n      (_lsu_io_ext_out_bits_we_n),	// core/src/core.scala:16:21
    .io_in_DataIn_1_ready          (_abt_io_in_DataIn_1_ready),
    .io_in_DataIn_1_valid          (_ifu_io_base_out_valid),	// core/src/core.scala:10:21
    .io_in_DataIn_1_bits_addr      (_ifu_io_base_out_bits_addr),	// core/src/core.scala:10:21
  ...
  forwarding fwctrl (	// core/src/core.scala:41:24
    .clock      (clock),
    .io_RJ      (_idu_io_RJ),	// core/src/core.scala:12:21
    .io_RK      (_idu_io_RK),	// core/src/core.scala:12:21
    .io_RD      (_idu_io_RD),	// core/src/core.scala:12:21
    .io_RDst    (_idu_io_RDst),	// core/src/core.scala:12:21
    .io_RSel    (_idu_io_RSel),	// core/src/core.scala:12:21
    .io_flush   (flush),	// core/src/core.scala:39:52
...
(*DONT_TOUCH="TRUE"*)module subtop(	// core/src/subtop.scala:5:7
  ...
  wire        _core_io_bus_out_valid;	// core/src/subtop.scala:11:18
  wire        _core_io_bus_out_bits_data_wen;	// core/src/subtop.scala:11:18
  wire [31:0] _core_io_bus_out_bits_data_in;	// core/src/subtop.scala:11:18
  wire [31:0] _core_io_bus_out_bits_addr;	// core/src/subtop.scala:11:18
  wire [3:0]  _core_io_bus_out_bits_be_n;	// core/src/subtop.scala:11:18
  wire        _core_io_bus_out_bits_ce_n;	// core/src/subtop.scala:11:18
  wire        _core_io_bus_out_bits_oe_n;	// core/src/subtop.scala:11:18
  wire        _core_io_bus_out_bits_we_n;	// core/src/subtop.scala:11:18
  core core (	// core/src/subtop.scala:11:18
    .clock                    (clock),
    .reset                    (reset),
  ...
  xbar xbar (	// core/src/subtop.scala:12:22
    ...
    .io_in_DataIn_valid             (_core_io_bus_out_valid),	// core/src/subtop.scala:11:18
    .io_in_DataIn_bits_data_wen     (_core_io_bus_out_bits_data_wen),	// core/src/subtop.scala:11:18
    .io_in_DataIn_bits_data_in      (_core_io_bus_out_bits_data_in),	// core/src/subtop.scala:11:18
    .io_in_DataIn_bits_addr         (_core_io_bus_out_bits_addr),	// core/src/subtop.scala:11:18
    .io_in_DataIn_bits_be_n         (_core_io_bus_out_bits_be_n),	// core/src/subtop.scala:11:18
    .io_in_DataIn_bits_ce_n         (_core_io_bus_out_bits_ce_n),	// core/src/subtop.scala:11:18
    .io_in_DataIn_bits_oe_n         (_core_io_bus_out_bits_oe_n),	// core/src/subtop.scala:11:18
    .io_in_DataIn_bits_we_n         (_core_io_bus_out_bits_we_n),	// core/src/subtop.scala:11:18
