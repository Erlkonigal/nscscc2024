...
set_input_delay -clock $gclk 17 [get_ports base_ram_data[*]] 
set_input_delay -clock $gclk 17 [get_ports ext_ram_data[*]] 
set_input_delay -clock $gclk 11 [get_ports reset_btn] 
set_input_delay  -clock $gclk 11 [get_ports rxd] 

set_output_delay -clock $gclk 11 [get_ports base_ram_addr[*]] 
set_output_delay -clock $gclk 11 [get_ports base_ram_be_n[*]] 
set_output_delay -clock $gclk 11 [get_ports base_ram_data[*]] 
set_output_delay -clock $gclk 11 [get_ports base_ram_oe_n] 
set_output_delay -clock $gclk 11 [get_ports base_ram_we_n] 
set_output_delay -clock $gclk 11 [get_ports ext_ram_addr[*]] 
set_output_delay -clock $gclk 11 [get_ports ext_ram_be_n[*]] 
set_output_delay -clock $gclk 11 [get_ports ext_ram_data[*]] 
set_output_delay -clock $gclk 11 [get_ports ext_ram_oe_n] 
set_output_delay -clock $gclk 11 [get_ports ext_ram_we_n] 
set_output_delay -clock $gclk 11 [get_ports ext_ram_ce_n] 
set_output_delay -clock $gclk 11 [get_ports txd] 
