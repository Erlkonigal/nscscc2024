...
set_output_delay -clock $gclk 10 [get_ports base_ram_addr[*]] 
set_output_delay -clock $gclk 10 [get_ports base_ram_be_n[*]] 
set_output_delay -clock $gclk 10 [get_ports base_ram_data[*]] 
set_output_delay -clock $gclk 10 [get_ports base_ram_oe_n] 
set_output_delay -clock $gclk 10 [get_ports base_ram_we_n] 
set_output_delay -clock $gclk 10 [get_ports ext_ram_addr[*]] 
set_output_delay -clock $gclk 10 [get_ports ext_ram_be_n[*]] 
set_output_delay -clock $gclk 10 [get_ports ext_ram_data[*]] 
set_output_delay -clock $gclk 10 [get_ports ext_ram_oe_n] 
set_output_delay -clock $gclk 10 [get_ports ext_ram_we_n] 
set_output_delay -clock $gclk 10 [get_ports ext_ram_ce_n] 
set_output_delay -clock $gclk 10 [get_ports txd] 
